    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav a me-auto mb-2 mb-lg-0 justify-content-center w-100">
                <li class="nav-item">
                <a class="nav-link ue nv me-2" href="index.php">HOME</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link ue nv me-2" href="accesseries.php">ACCESSERIES</a>
                </li>
                <li class="nav-item">
                <a class="nav-link ue nv me-2" href="premium.php">PREMIUM</a>
                </li>
            </ul>
        <div class="d-flex">
            <?php 
